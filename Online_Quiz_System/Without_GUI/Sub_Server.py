...
def Programming():
    ...
    if response.decode() == "Okay":
        questions = [
        ("What is the name of the sorting algorithm that repeatedly steps through the list, compares adjacent elements, and swaps them if they are in the wrong order?", "bubblesort"),
